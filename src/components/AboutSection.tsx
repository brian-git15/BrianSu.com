    ...
    <GlassCard className="p-6">
      ...
      <div className="mt-5 flex flex-col items-center gap-3 sm:flex-row sm:items-start sm:gap-5">
        <a
          ...
          className="flex-shrink-0 rounded-full ring-2 ring-foreground/20 transition hover:ring-foreground/50 focus:outline-none focus:ring-2 focus:ring-foreground/50"
